/**
 * Custom Icons for Optimize Component
 * Replaces non-existent lucide-react icons
 */
...
export const Rocket = ({ className = '', size = 24 }: IconProps) => (
    <svg
        ...
        className={className}
    >
        <path d="M4.5 16.5c-1.5-1-2-5-2-8.5a9 9 0 0 1 18 0c0 3.5-.5 7.5-2 8.5M12 4v7m3 3H9"></path>
    </svg>
);
