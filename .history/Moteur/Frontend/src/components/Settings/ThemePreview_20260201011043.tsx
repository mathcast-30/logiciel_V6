        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                >
                    ...
                    <p className="text-sm" style={{ color: colors.text }} className="opacity-75">
                        Texte petit et secondaire
                    </p>
                    <p className="text-xs" style={{ color: colors.text }} className="opacity-50">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {[
                        ...
                        >
                            ...
                            <p className="text-xs mt-1" style={{ color: colors.text }} className="opacity-75">
                                {card.desc}
                            </p>
                        </div>
                    ))}
