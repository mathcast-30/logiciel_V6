        ...
        <div className="space-y-6 text-slate-900 border-none dark:text-white">
            ...
            {isLoading ? (
                ...
                <>
                            ...
                            <div className="card p-6">
                                ...
                                {isLoadingMaterials ? (
                                    <div className="flex items-center justify-center py-8">
                                        <div className="spinner !w-8 !h-8 border-3 !border-emerald-500 !border-t-transparent" />
                                    </div>
                                ) : (
                                    <MaterialBreakdown
                        ...
                        {identifiedMaterials.length > 0 && (
                            <div className="card p-6">
                                ...
                                <MaterialSourceSelector
                                    ...
                                    onSourceChange={setMaterialSources}
                                />
                            </div>
                        )}
                                    ...
                                    {selectedEngine === 'raw_wood' && (
                                        <div className="mt-4 pt-4 border-t border-slate-200 dark:border-slate-700">
                                            <RawWoodConfigPanel
                                                params={rawWoodParams}
                                                algorithm={rawWoodAlgorithm}
                                                onParamsChange={setRawWoodParams}
                                                onAlgorithmChange={setRawWoodAlgorithm}
                                            />
                                        </div>
                                    )}
                    ...
                    {/* Old Project Selection - HIDDEN but kept for reference */}
                    {false && (
