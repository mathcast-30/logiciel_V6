...
import {
    ...
    Sparkles, BarChart3, AlertTriangle as AlertTriangleIcon, Printer, Wrench as WrenchIcon,
    Rocket, CheckCircle
} from 'lucide-react';
...
export function Optimize() {
    ...
    // Fonction non utilisée - kept for future use
    const applyAiSuggestion = (_suggestion: BatchSuggestion) => {
