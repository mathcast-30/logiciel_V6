...
import { ContrastChecker } from '../components/Settings/ContrastChecker';
...
export function SettingsPage() {
    ...
    return (
        <div className="space-y-6 max-w-4xl">
            ...
            <div className="card border-l-4 border-l-pink-500 dark:border-l-pink-500">
                <div className="card-header flex items-center gap-2">
                    <Palette className="h-5 w-5 text-pink-500" />
                    <h2 className="font-semibold text-slate-800 dark:text-white">Personnalisation des Couleurs</h2>
                </div>
                <div className="card-body">
                    <ColorCustomizer />
                </div>
            ...
            {/* Présets de Couleurs */}
            <div className="card border-l-4 border-l-amber-500 dark:border-l-amber-500">
                <div className="card-header flex items-center gap-2">
                    <Sparkles className="h-5 w-5 text-amber-500" />
                    <h2 className="font-semibold text-slate-800 dark:text-white">Présets & Export</h2>
                </div>
                <div className="card-body">
                    <PresetSelector />
                </div>
            ...
            <div className="card border-l-4 border-l-green-500 dark:border-l-green-500">
                <div className="card-header flex items-center gap-2">
                    <AlertCircle className="h-5 w-5 text-green-500" />
                    <h2 className="font-semibold text-slate-800 dark:text-white">Accessibilité</h2>
                </div>
                <div className="card-body">
                    <ContrastChecker />
                </div>
